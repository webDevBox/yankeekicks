...
@section('content')
<h4 class="text-center text-dark"> Login to Yankeekicks </h4>
            <form action="{{ route('userLogin') }}" method="POST" class="p-3">
                @csrf
                <div class="mb-3">
              ...
              <p class="d-inline">Don't have account</p><a href="{{ route('userAuth.create') }}"> Register</a>
